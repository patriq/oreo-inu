...
class GreaterDemons(ctx: ScriptContext) : BaseSlayerTaskInfo(ctx) {
    override fun monsterNames(): Array<String> = arrayOf("Greater demon")

    override fun standingArea(): Area = ChasmOfFire.getArea(ChasmOfFire.Location.GREATER_DEMONS)
